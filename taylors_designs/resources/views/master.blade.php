...
<link type="text/css" href="{{ asset('css/mstyle.css') }}" rel="stylesheet" media="(max-device-width:720px)" />
	...
	<nav class="navbar navbar-default row" role="navbar">
     <div class="container-fluid">
    	<div class="navbar-header">
            <span class="visible-xs-inline-block"><a href="/"><img src="/assets/images/logom.png" id="logo_mobile" /></a></span>
